...
import { useGetNoteSharedByMeDataQuery, useShareNoteMutation, useUpdateNoteMutation } from "../../api/note/noteApi";
import { toast } from "react-toastify";
import { FaSave, FaShare } from "react-icons/fa";

const noteTypes = ["Personal", "Work", "Project", "Reminder"];

const SharedNoteByUser = ({userList}) => {
  ...
  const {data} = useGetNoteSharedByMeDataQuery({accessToken: accessToken});
  console.log(data);
...
export default SharedNoteByUser;
